      ...
      <div className="footer">
        ...
        <div className="mobile-section-footer">
          ...
          <div
            ...
            style={{ height: coll ? "70px" : "250px" }}
          >
            <div
              className="left-container-scroll-block"
              onClick={() => setColl(!coll)}
              style={{ cursor: "pointer" }}
            >
              <h1 style={{ color: "black" }}>Our Company</h1>
          ...
          <div
            className="footer-second"
            style={{ height: coll1 ? "70px" : "300px" }}
          >
            <div
              className="left-container-scroll-block"
              onClick={() => setColl1(!coll1)}
              style={{ cursor: "pointer" }}
            >
          ...
          <div
            className="footer-second"
            style={{ height: coll2 ? "70px" : "350px" }}
          >
            <div
              className="left-container-scroll-block"
              onClick={() => setColl2(!coll2)}
              style={{ cursor: "pointer" }}
            >
              <h1 style={{ color: "black" }}>Sign Up to Newsletter</h1>
